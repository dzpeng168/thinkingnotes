 ...
 */
export function TemplateRenderer({ value, onChange, noteId, initialMode, readOnly }: Props) {
  return <MarkdownTemplate value={value} onChange={onChange} noteId={noteId} initialMode={initialMode} readOnly={readOnly} />
}
