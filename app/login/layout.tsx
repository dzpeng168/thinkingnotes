...
export function generateMetadata(): Metadata {
  ...
  if (locale === 'zh') {
    return {
      ...
      description:
        '16 种思维模型模板 · 云端多端同步 · 原生 Markdown 体验。康奈尔笔记、5W2H、六顶思考帽、WOOP，从灵感到行动一步到位。',
      keywords: [
      ...
      openGraph: {
        title: 'ThinkingNotes — 思维笔记，让思考更有条理',
        description: '16 种思维模型模板 · 云端多端同步 · 原生 Markdown 体验',
        type: 'website',
      ...
      twitter: {
        card: 'summary',
        title: 'ThinkingNotes',
        description: '思维笔记 · 16 种模板 · 云端多端同步',
      },
  ...
  return {
    ...
    description:
      '16 thinking-model templates · Cloud sync · Native Markdown editor. Cornell, 5W2H, Six Thinking Hats, WOOP — from inspiration to action.',
    keywords: [
    ...
    openGraph: {
      title: 'ThinkingNotes — Make thinking organized',
      description: '16 thinking-model templates · Cloud sync · Native Markdown editor',
      type: 'website',
      siteName: 'ThinkingNotes',
      url: canonical,
      locale: 'en_US',
