...
const META_BY_LOCALE: Record<"zh" | "en", {
  ...
  zh: {
    ...
    description: '帮你把想问题变得更有条理。康奈尔笔记、5W2H、六顶思考帽、WOOP 等 16 种思维模型模板，云端多端同步，原生 Markdown 体验。',
    keywords: ['思维笔记', '模板笔记', '康奈尔笔记', '5W2H', '六顶思考帽', '思维模型', 'Markdown 笔记', 'Note-taking', 'ThinkingNotes'],
    ogTitle: 'ThinkingNotes — 帮你把想问题变得更有条理',
    ogDesc: '16 种思维模型模板 · 云端多端同步 · 原生 Markdown 体验',
  },
  en: {
    title: 'ThinkingNotes',
    description: 'Make thinking more efficient and organized. 16 thinking-model templates including Cornell, 5W2H, Six Thinking Hats, WOOP — cloud-synced, native Markdown.',
    ...
    ogDesc: '16 thinking-model templates · Cloud sync · Native Markdown editor',
  },
}
