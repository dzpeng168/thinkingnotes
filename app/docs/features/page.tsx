...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (locale === 'zh') {
    return {
      ...
      description:
        'ThinkingNotes 的全部功能：20 种思维模型模板、云端多端同步、原生 Markdown 编辑器、自动保存、标签与分类管理。',
      keywords: [
  ...
  return {
    ...
    description:
      'All ThinkingNotes features: 20 thinking-model templates, cloud sync across devices, native Markdown editor, auto-save, tags & categories.',
    keywords: [
